...
export enum CoreRepositoryEnum {
  ...
  PLACE_SCHEDULES_REPOSITORY = 'PLACE_SCHEDULES_REPOSITORY',
  /*--------*/
  //entidades luis
  ENTRANCE_FEE_REPOSITORY = 'ENTRANCE_FEE_REPOSITORY',
  PLACE_STYLE_REPOSITORY = 'PLACE_STYLE_REPOSITORY',
  TOUR_GUIDE_REPOSITORY = 'TOUR_GUIDE_REPOSITORY',
  TOUR_GUIDE_LANGUAGE_REPOSITORY = 'TOUR_GUIDE_LANGUAGE_REPOSITORY',
}
